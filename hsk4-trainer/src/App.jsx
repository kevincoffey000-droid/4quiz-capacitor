...
const STYLES = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .level-tabs { position: relative; width: 70px; height: 34px; margin-top: -6px; }
      ...
      <div className="app">
        <div className="top-bar">
          <div className="level-tabs">
            <svg className="level-tabs-svg" width="70" height="34" viewBox="0 0 70 34">
              <rect className="lt-bg" x="0" y="0" width="70" height="34" />
              <g className="lt-stroke-group">
                <path d="M 0 7 L 51 7 C 60 7 62 10 65 17" />
