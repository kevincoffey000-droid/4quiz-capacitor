...
const STYLES = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .level-tabs { position: relative; width: 76px; height: 34px; margin-top: -6px; }
      ...
      <div className="app">
        <div className="top-bar">
          <div className="level-tabs">
            <svg className="level-tabs-svg" width="76" height="34" viewBox="0 0 76 34">
              <rect className="lt-bg" x="0" y="0" width="76" height="34" />
