...
const HSK3_WORDS = [
  ...
  { hanzi: "矮", pinyin: "ǎi", english: "short (height)" },
  { hanzi: "爱人", pinyin: "àiren", english: "spouse" },
  { hanzi: "安静", pinyin: "ānjìng", english: "quiet" },
  { hanzi: "安全", pinyin: "ānquán", english: "safe, safety" },
  { hanzi: "把", pinyin: "bǎ", english: "particle for object-fronting; handle" },
  ...
  { hanzi: "办法", pinyin: "bànfǎ", english: "way, solution, method" },
  { hanzi: "办公室", pinyin: "bàngōngshì", english: "office" },
  { hanzi: "半天", pinyin: "bàntiān", english: "half a day; a long time" },
  { hanzi: "帮助", pinyin: "bāngzhù", english: "to help, help" },
  { hanzi: "饱", pinyin: "bǎo", english: "full (after eating)" },
  { hanzi: "报纸", pinyin: "bàozhǐ", english: "newspaper" },
  { hanzi: "北", pinyin: "běi", english: "north" },
  { hanzi: "北方", pinyin: "běifāng", english: "northern region, north" },
  { hanzi: "被", pinyin: "bèi", english: "by (passive marker)" },
  { hanzi: "笔记", pinyin: "bǐjì", english: "notes" },
  { hanzi: "比较", pinyin: "bǐjiào", english: "to compare; relatively, quite" },
  { hanzi: "笔记本", pinyin: "bǐjìběn", english: "notebook" },
  { hanzi: "比如", pinyin: "bǐrú", english: "for example" },
  { hanzi: "比赛", pinyin: "bǐsài", english: "competition, match, to compete" },
  ...
  { hanzi: "变化", pinyin: "biànhuà", english: "change, to change" },
  { hanzi: "表演", pinyin: "biǎoyǎn", english: "to perform, to act" },
  { hanzi: "别的", pinyin: "biéde", english: "other, else" },
  { hanzi: "别人", pinyin: "biérén", english: "other people, others" },
  { hanzi: "宾馆", pinyin: "bīnguǎn", english: "hotel" },
  { hanzi: "冰", pinyin: "bīng", english: "ice" },
  { hanzi: "冰激凌", pinyin: "bīngjīlíng", english: "ice cream" },
  { hanzi: "冰箱", pinyin: "bīngxiāng", english: "refrigerator" },
  { hanzi: "病人", pinyin: "bìngrén", english: "patient, sick person" },
  { hanzi: "不但", pinyin: "búdàn", english: "not only" },
  { hanzi: "不见", pinyin: "bújiàn", english: "to disappear, to not see" },
  { hanzi: "不用", pinyin: "búyòng", english: "need not, no need to" },
  { hanzi: "不同", pinyin: "bùtóng", english: "different, not the same" },
  { hanzi: "不久", pinyin: "bùjiǔ", english: "soon, not long after" },
  { hanzi: "不行", pinyin: "bùxíng", english: "not allowed, won't do" },
  { hanzi: "才", pinyin: "cái", english: "just, only, not until" },
  { hanzi: "菜单", pinyin: "càidān", english: "menu" },
  { hanzi: "参加", pinyin: "cānjiā", english: "to join, to attend, to participate" },
  { hanzi: "草", pinyin: "cǎo", english: "grass, straw" },
  { hanzi: "草地", pinyin: "cǎodì", english: "grassland, lawn" },
  { hanzi: "层", pinyin: "céng", english: "layer, floor (of a building)" },
  { hanzi: "查", pinyin: "chá", english: "to check, to look up" },
  { hanzi: "差", pinyin: "chà", english: "bad, poor; to lack" },
  { hanzi: "差不多", pinyin: "chàbuduō", english: "almost, nearly, similar" },
  { hanzi: "尝", pinyin: "cháng", english: "to taste, to try" },
  { hanzi: "常", pinyin: "cháng", english: "often, frequently" },
  { hanzi: "常见", pinyin: "chángjiàn", english: "common, commonly seen" },
  { hanzi: "常用", pinyin: "chángyòng", english: "commonly used" },
  { hanzi: "常常", pinyin: "chángcháng", english: "often, frequently" },
  { hanzi: "衬衫", pinyin: "chènshān", english: "shirt, blouse" },
  { hanzi: "成绩", pinyin: "chéngjì", english: "score, grade, achievement" },
  { hanzi: "城市", pinyin: "chéngshì", english: "city, town" },
  { hanzi: "迟到", pinyin: "chídào", english: "to be late, to arrive late" },
  { hanzi: "出发", pinyin: "chūfā", english: "to set out, to depart" },
  ...
  { hanzi: "除了", pinyin: "chúle", english: "except, besides, apart from" },
  { hanzi: "船", pinyin: "chuán", english: "boat, ship" },
  { hanzi: "春天", pinyin: "chūntiān", english: "spring (season)" },
  { hanzi: "词典", pinyin: "cídiǎn", english: "dictionary" },
  { hanzi: "聪明", pinyin: "cōngmíng", english: "smart, clever, intelligent" },
  { hanzi: "打扫", pinyin: "dǎsǎo", english: "to clean, to sweep" },
  { hanzi: "打算", pinyin: "dǎsuàn", english: "to plan, to intend; plan" },
  { hanzi: "大概", pinyin: "dàgài", english: "probably, approximately, general" },
  { hanzi: "大人", pinyin: "dàren", english: "adult, grown-up" },
  ...
  { hanzi: "带", pinyin: "dài", english: "to bring, to take, to carry" },
  { hanzi: "担心", pinyin: "dānxīn", english: "to worry, to be concerned" },
  { hanzi: "蛋糕", pinyin: "dàngāo", english: "cake" },
  { hanzi: "当然", pinyin: "dāngrán", english: "of course, certainly" },
  { hanzi: "到处", pinyin: "dàochù", english: "everywhere, all over" },
  { hanzi: "得", pinyin: "dé", english: "to get, to obtain" },
  { hanzi: "得到", pinyin: "dédào", english: "to get, to obtain, to receive" },
  { hanzi: "得分", pinyin: "défēn", english: "to score; score" },
  { hanzi: "的话", pinyin: "dehuà", english: "if... (conditional particle)" },
  { hanzi: "得", pinyin: "děi", english: "must, need to" },
  { hanzi: "灯", pinyin: "dēng", english: "lamp, light, lantern" },
  { hanzi: "地", pinyin: "dì", english: "ground, earth, land" },
  { hanzi: "地点", pinyin: "dìdiǎn", english: "place, location, venue" },
  { hanzi: "地方", pinyin: "dìfang", english: "place, area, region" },
  { hanzi: "地图", pinyin: "dìtú", english: "map" },
  { hanzi: "电", pinyin: "diàn", english: "electricity; electric" },
  { hanzi: "电梯", pinyin: "diàntī", english: "elevator, escalator" },
  ...
  { hanzi: "东方", pinyin: "dōngfāng", english: "east, the East" },
  { hanzi: "东南", pinyin: "dōngnán", english: "southeast" },
  { hanzi: "冬天", pinyin: "dōngtiān", english: "winter" },
  { hanzi: "懂得", pinyin: "dǒngde", english: "to understand, to grasp" },
  { hanzi: "动物", pinyin: "dòngwù", english: "animal" },
  { hanzi: "动物园", pinyin: "dòngwùyuán", english: "zoo" },
  { hanzi: "短", pinyin: "duǎn", english: "short (in length)" },
  { hanzi: "短裤", pinyin: "duǎnkù", english: "shorts" },
  { hanzi: "段", pinyin: "duàn", english: "segment, paragraph; measure word" },
  { hanzi: "锻炼", pinyin: "duànliàn", english: "to exercise, to train" },
  { hanzi: "对话", pinyin: "duìhuà", english: "dialogue, conversation" },
  { hanzi: "饿", pinyin: "è", english: "hungry" },
  { hanzi: "而且", pinyin: "érqiě", english: "and, moreover, furthermore" },
  { hanzi: "耳朵", pinyin: "ěrduo", english: "ear" },
  { hanzi: "耳机", pinyin: "ěrjī", english: "earphones, headphones" },
  { hanzi: "发", pinyin: "fā", english: "to send, to issue" },
  { hanzi: "发烧", pinyin: "fāshāo", english: "to have a fever" },
  { hanzi: "发生", pinyin: "fāshēng", english: "to happen, to occur" },
  { hanzi: "发现", pinyin: "fāxiàn", english: "to find, to discover" },
  { hanzi: "发展", pinyin: "fāzhǎn", english: "to develop, development" },
  { hanzi: "方便", pinyin: "fāngbiàn", english: "convenient" },
  { hanzi: "方便面", pinyin: "fāngbiànmiàn", english: "instant noodles" },
  { hanzi: "方法", pinyin: "fāngfǎ", english: "method, way, approach" },
  { hanzi: "方向", pinyin: "fāngxiàng", english: "direction" },
  { hanzi: "房子", pinyin: "fángzi", english: "house, building" },
  { hanzi: "放", pinyin: "fàng", english: "to put, to place, to release" },
  { hanzi: "放假", pinyin: "fàngjià", english: "to have a holiday, to go on vacation" },
  { hanzi: "放心", pinyin: "fàngxīn", english: "to feel at ease, to relax" },
  { hanzi: "放学", pinyin: "fàngxué", english: "school's out, end of school day" },
  { hanzi: "分开", pinyin: "fēnkāi", english: "to separate, to part" },
  { hanzi: "风", pinyin: "fēng", english: "wind" },
  { hanzi: "封", pinyin: "fēng", english: "measure word for letters; to seal" },
  { hanzi: "夫妻", pinyin: "fūqī", english: "husband and wife, couple" },
  { hanzi: "服务", pinyin: "fúwù", english: "to serve, service" },
  { hanzi: "附近", pinyin: "fùjìn", english: "nearby, in the vicinity" },
  { hanzi: "复习", pinyin: "fùxí", english: "to review (studies)" },
  { hanzi: "该", pinyin: "gāi", english: "should, ought to" },
  { hanzi: "干净", pinyin: "gānjìng", english: "clean, neat and tidy" },
  { hanzi: "感兴趣", pinyin: "gǎn xìngqù", english: "to be interested in" },
  { hanzi: "感到", pinyin: "gǎndào", english: "to feel, to sense" },
  ...
  { hanzi: "刚才", pinyin: "gāngcái", english: "just now, a moment ago" },
  { hanzi: "刚刚", pinyin: "gānggāng", english: "just now, just a moment ago" },
  { hanzi: "高铁", pinyin: "gāotiě", english: "high-speed rail" },
  { hanzi: "根据", pinyin: "gēnjù", english: "according to, based on" },
  { hanzi: "更", pinyin: "gèng", english: "even more, still more" },
  { hanzi: "公斤", pinyin: "gōngjīn", english: "kilogram" },
  { hanzi: "公园", pinyin: "gōngyuán", english: "park" },
  { hanzi: "工作日", pinyin: "gōngzuòrì", english: "workday, weekday" },
  { hanzi: "故事", pinyin: "gùshi", english: "story, tale" },
  { hanzi: "刮", pinyin: "guā", english: "to scrape, to blow (wind)" },
  { hanzi: "关", pinyin: "guān", english: "to close, to turn off" },
  { hanzi: "关机", pinyin: "guānjī", english: "to turn off (device)" },
  { hanzi: "关系", pinyin: "guānxì", english: "relationship, connection" },
  { hanzi: "关心", pinyin: "guānxīn", english: "to care about, to be concerned" },
  { hanzi: "关于", pinyin: "guānyú", english: "about, regarding, concerning" },
  ...
  { hanzi: "过去", pinyin: "guòqù", english: "past, former times" },
  { hanzi: "海", pinyin: "hǎi", english: "sea, ocean" },
  { hanzi: "害怕", pinyin: "hàipà", english: "to be afraid, to fear" },
  { hanzi: "好多", pinyin: "hǎoduō", english: "many, a lot, quite a few" },
  { hanzi: "好久", pinyin: "hǎojiǔ", english: "a long time" },
  { hanzi: "好像", pinyin: "hǎoxiàng", english: "to seem, as if, to look like" },
  { hanzi: "号码", pinyin: "hàomǎ", english: "number, code" },
  { hanzi: "河", pinyin: "hé", english: "river" },
  { hanzi: "合适", pinyin: "héshì", english: "suitable, appropriate, fitting" },
  { hanzi: "黑板", pinyin: "hēibǎn", english: "blackboard" },
  { hanzi: "红绿灯", pinyin: "hónglǜdēng", english: "traffic light" },
  { hanzi: "后来", pinyin: "hòulái", english: "afterwards, later" },
  ...
  { hanzi: "环境", pinyin: "huánjìng", english: "environment, surroundings" },
  { hanzi: "换", pinyin: "huàn", english: "to exchange, to change" },
  { hanzi: "黄色", pinyin: "huángsè", english: "yellow (colour)" },
  { hanzi: "回答", pinyin: "huídá", english: "to answer, to reply" },
  { hanzi: "会", pinyin: "huì", english: "meeting" },
  { hanzi: "会议", pinyin: "huìyì", english: "meeting, conference" },
  { hanzi: "或", pinyin: "huò", english: "or, perhaps" },
  { hanzi: "或者", pinyin: "huòzhě", english: "or (in statements)" },
  { hanzi: "鸡", pinyin: "jī", english: "chicken" },
  { hanzi: "几乎", pinyin: "jīhū", english: "almost, nearly" },
  { hanzi: "机会", pinyin: "jīhuì", english: "opportunity, chance" },
  { hanzi: "极", pinyin: "jí", english: "extremely, to the utmost" },
  { hanzi: "急", pinyin: "jí", english: "urgent; to worry" },
  { hanzi: "记", pinyin: "jì", english: "to remember, to record" },
  { hanzi: "季", pinyin: "jì", english: "season" },
  { hanzi: "季节", pinyin: "jìjié", english: "season" },
  { hanzi: "加", pinyin: "jiā", english: "to add, to increase" },
  { hanzi: "假期", pinyin: "jiàqī", english: "vacation, holiday" },
  { hanzi: "坚持", pinyin: "jiānchí", english: "to persist, to keep on" },
  { hanzi: "检查", pinyin: "jiǎnchá", english: "to check, to inspect, to examine" },
  { hanzi: "简单", pinyin: "jiǎndān", english: "simple, easy" },
  { hanzi: "检票", pinyin: "jiǎnpiào", english: "ticket checking" },
  { hanzi: "健康", pinyin: "jiànkāng", english: "healthy, health" },
  { hanzi: "见面", pinyin: "jiànmiàn", english: "to meet, to meet up" },
  { hanzi: "讲", pinyin: "jiǎng", english: "to speak, to explain, to tell" },
  { hanzi: "角", pinyin: "jiǎo", english: "corner; jiao (0.1 yuan)" },
  { hanzi: "脚", pinyin: "jiǎo", english: "foot" },
  { hanzi: "接", pinyin: "jiē", english: "to pick up, to receive, to connect" },
  { hanzi: "街", pinyin: "jiē", english: "street" },
  { hanzi: "节", pinyin: "jié", english: "festival; measure word for lessons" },
  { hanzi: "结婚", pinyin: "jiéhūn", english: "to get married" },
  { hanzi: "节目", pinyin: "jiémù", english: "program, show, performance" },
  { hanzi: "节日", pinyin: "jiérì", english: "festival, holiday" },
  { hanzi: "结束", pinyin: "jiéshù", english: "to end, to finish" },
  { hanzi: "解决", pinyin: "jiějué", english: "to solve, to resolve" },
  { hanzi: "姐妹", pinyin: "jiěmèi", english: "sisters" },
  { hanzi: "借", pinyin: "jiè", english: "to borrow, to lend" },
  { hanzi: "斤", pinyin: "jīn", english: "catty (500g weight unit)" },
  { hanzi: "经过", pinyin: "jīngguò", english: "to pass, to go through" },
  { hanzi: "经理", pinyin: "jīnglǐ", english: "manager, director" },
  { hanzi: "久", pinyin: "jiǔ", english: "long (time)" },
  { hanzi: "酒", pinyin: "jiǔ", english: "alcohol, liquor, wine" },
  { hanzi: "旧", pinyin: "jiù", english: "old, used, former" },
  { hanzi: "句", pinyin: "jù", english: "measure word for sentences" },
  { hanzi: "句子", pinyin: "jùzi", english: "sentence" },
  { hanzi: "决定", pinyin: "juédìng", english: "to decide; decision" },
  { hanzi: "卡", pinyin: "kǎ", english: "card" },
  { hanzi: "开花", pinyin: "kāihuā", english: "to bloom, to blossom" },
  { hanzi: "开会", pinyin: "kāihuì", english: "to have a meeting" },
  { hanzi: "开机", pinyin: "kāijī", english: "to turn on (a device)" },
  ...
  { hanzi: "可爱", pinyin: "kě'ài", english: "cute, adorable, lovely" },
  { hanzi: "可是", pinyin: "kěshì", english: "but, however" },
  { hanzi: "刻", pinyin: "kè", english: "quarter (of an hour); to carve" },
  { hanzi: "课本", pinyin: "kèběn", english: "textbook" },
  { hanzi: "客人", pinyin: "kèrén", english: "guest, visitor" },
  { hanzi: "课文", pinyin: "kèwén", english: "text, lesson text" },
  ...
  { hanzi: "老", pinyin: "lǎo", english: "old, aged; (prefix of endearment)" },
  { hanzi: "老人", pinyin: "lǎorén", english: "elderly person, old person" },
  { hanzi: "离开", pinyin: "líkāi", english: "to leave, to depart" },
  { hanzi: "礼物", pinyin: "lǐwù", english: "gift, present" },
  { hanzi: "历史", pinyin: "lìshǐ", english: "history" },
  { hanzi: "脸", pinyin: "liǎn", english: "face" },
  { hanzi: "练", pinyin: "liàn", english: "to practice, to train" },
  { hanzi: "练习", pinyin: "liànxí", english: "to practice; exercise" },
  { hanzi: "凉快", pinyin: "liángkuai", english: "cool, pleasantly cool" },
  { hanzi: "辆", pinyin: "liàng", english: "measure word for vehicles" },
  { hanzi: "聊", pinyin: "liáo", english: "to chat, to talk" },
  { hanzi: "聊天儿", pinyin: "liáotiānr", english: "to chat, to have a chat" },
  { hanzi: "了解", pinyin: "liǎojiě", english: "to understand, to know about" },
  ...
  { hanzi: "路边", pinyin: "lùbiān", english: "roadside, beside the road" },
  { hanzi: "路口", pinyin: "lùkǒu", english: "intersection, road junction" },
  { hanzi: "马", pinyin: "mǎ", english: "horse" },
  { hanzi: "马路", pinyin: "mǎlù", english: "road, street" },
  { hanzi: "马上", pinyin: "mǎshàng", english: "immediately, at once" },
  { hanzi: "满意", pinyin: "mǎnyì", english: "satisfied, pleased" },
  { hanzi: "毛", pinyin: "máo", english: "mao (0.1 yuan); hair" },
  { hanzi: "米", pinyin: "mǐ", english: "meter; rice" },
  { hanzi: "面前", pinyin: "miànqián", english: "in front of, before" },
  { hanzi: "明白", pinyin: "míngbai", english: "to understand; clear, obvious" },
  { hanzi: "名单", pinyin: "míngdān", english: "name list" },
  { hanzi: "名人", pinyin: "míngrén", english: "famous person, celebrity" },
  { hanzi: "南", pinyin: "nán", english: "south" },
  { hanzi: "难", pinyin: "nán", english: "difficult, hard" },
  { hanzi: "南方", pinyin: "nánfāng", english: "southern region, south" },
  { hanzi: "难过", pinyin: "nánguò", english: "sad, to feel bad" },
  { hanzi: "难看", pinyin: "nánkàn", english: "ugly, unpleasant-looking" },
  { hanzi: "男人", pinyin: "nánrén", english: "man, male" },
  ...
  { hanzi: "年级", pinyin: "niánjí", english: "grade, year (in school)" },
  { hanzi: "年轻", pinyin: "niánqīng", english: "young" },
  { hanzi: "牛", pinyin: "niú", english: "cow; awesome (slang)" },
  { hanzi: "努力", pinyin: "nǔlì", english: "to work hard, hardworking" },
  { hanzi: "女人", pinyin: "nǚrén", english: "woman, female" },
  { hanzi: "女生", pinyin: "nǚshēng", english: "female student, girl" },
  { hanzi: "爬", pinyin: "pá", english: "to climb, to crawl" },
  { hanzi: "怕", pinyin: "pà", english: "to fear, to be afraid" },
  { hanzi: "拍照", pinyin: "pāizhào", english: "to take a photo" },
  { hanzi: "盘子", pinyin: "pánzi", english: "plate, dish, tray" },
  { hanzi: "胖", pinyin: "pàng", english: "fat, overweight, chubby" },
  { hanzi: "啤酒", pinyin: "píjiǔ", english: "beer" },
  { hanzi: "平时", pinyin: "píngshí", english: "usually, ordinarily, in normal times" },
  { hanzi: "瓶子", pinyin: "píngzi", english: "bottle" },
  { hanzi: "骑", pinyin: "qí", english: "to ride (bike, horse)" },
  { hanzi: "奇怪", pinyin: "qíguài", english: "strange, odd, weird" },
  { hanzi: "其实", pinyin: "qíshí", english: "actually, in fact" },
  { hanzi: "其他", pinyin: "qítā", english: "other, the rest, else" },
  { hanzi: "起", pinyin: "qǐ", english: "to rise, to get up" },
  { hanzi: "起飞", pinyin: "qǐfēi", english: "to take off (aircraft)" },
  { hanzi: "汽车", pinyin: "qìchē", english: "car, automobile" },
  ...
  { hanzi: "清楚", pinyin: "qīngchu", english: "clear, distinct; to understand clearly" },
  { hanzi: "请假", pinyin: "qǐngjià", english: "to ask for leave" },
  { hanzi: "请客", pinyin: "qǐngkè", english: "to treat someone, to invite guests" },
  { hanzi: "秋天", pinyin: "qiūtiān", english: "autumn, fall" },
  { hanzi: "球场", pinyin: "qiúchǎng", english: "sports field, court" },
  { hanzi: "裙子", pinyin: "qúnzi", english: "skirt, dress" },
  { hanzi: "然后", pinyin: "ránhòu", english: "then, after that, afterwards" },
  { hanzi: "热情", pinyin: "rèqíng", english: "enthusiastic, warm, passionate" },
  { hanzi: "认得", pinyin: "rènde", english: "to recognize, to know" },
  { hanzi: "认为", pinyin: "rènwéi", english: "to think, to consider, to believe" },
  { hanzi: "认真", pinyin: "rènzhēn", english: "serious, earnest, conscientious" },
  { hanzi: "容易", pinyin: "róngyì", english: "easy, likely" },
  { hanzi: "如果", pinyin: "rúguǒ", english: "if, in case" },
  { hanzi: "伞", pinyin: "sǎn", english: "umbrella" },
  { hanzi: "扫", pinyin: "sǎo", english: "to sweep, to scan" },
  { hanzi: "沙发", pinyin: "shāfā", english: "sofa, couch" },
  { hanzi: "山", pinyin: "shān", english: "mountain, hill" },
  { hanzi: "上衣", pinyin: "shàngyī", english: "jacket, top garment" },
  { hanzi: "勺子", pinyin: "sháozi", english: "spoon, ladle" },
  { hanzi: "身边", pinyin: "shēnbiān", english: "by one's side" },
  { hanzi: "身高", pinyin: "shēngāo", english: "height (of a person)" },
  { hanzi: "声", pinyin: "shēng", english: "sound, voice; measure word for sounds" },
  { hanzi: "生活", pinyin: "shēnghuó", english: "life; to live" },
  { hanzi: "生气", pinyin: "shēngqì", english: "to get angry, angry" },
  { hanzi: "声音", pinyin: "shēngyīn", english: "sound, voice, noise" },
  { hanzi: "市", pinyin: "shì", english: "city, municipality" },
  { hanzi: "试", pinyin: "shì", english: "to try, to test" },
  { hanzi: "室", pinyin: "shì", english: "room" },
  { hanzi: "世界", pinyin: "shìjiè", english: "world" },
  { hanzi: "收", pinyin: "shōu", english: "to receive, to collect" },
  { hanzi: "收到", pinyin: "shōudào", english: "to receive, to get" },
  { hanzi: "受", pinyin: "shòu", english: "to receive, to be affected" },
  { hanzi: "瘦", pinyin: "shòu", english: "thin, slim, lean" },
  { hanzi: "受到", pinyin: "shòudào", english: "to receive, to be subjected to" },
  { hanzi: "叔叔", pinyin: "shūshu", english: "uncle (father's younger brother)" },
  { hanzi: "树", pinyin: "shù", english: "tree" },
  { hanzi: "数学", pinyin: "shùxué", english: "mathematics, math" },
  { hanzi: "刷", pinyin: "shuā", english: "to brush, to scrub" },
  { hanzi: "双", pinyin: "shuāng", english: "pair, double; measure word for pairs" },
  { hanzi: "水平", pinyin: "shuǐpíng", english: "level, standard, proficiency" },
  { hanzi: "司机", pinyin: "sījī", english: "driver, chauffeur" },
  { hanzi: "四季", pinyin: "sìjì", english: "four seasons" },
  { hanzi: "太阳", pinyin: "tàiyáng", english: "sun" },
  { hanzi: "糖", pinyin: "táng", english: "candy, sugar, sweets" },
  { hanzi: "特别", pinyin: "tèbié", english: "special; particularly, especially" },
  { hanzi: "提高", pinyin: "tígāo", english: "to raise, to improve, to enhance" },
  { hanzi: "体育", pinyin: "tǐyù", english: "physical education, sports" },
  { hanzi: "体育馆", pinyin: "tǐyùguǎn", english: "gymnasium, sports hall" },
  { hanzi: "甜", pinyin: "tián", english: "sweet" },
  { hanzi: "跳", pinyin: "tiào", english: "to jump, to leap" },
  { hanzi: "听说", pinyin: "tīngshuō", english: "to hear (that), I've heard that" },
  { hanzi: "挺", pinyin: "tǐng", english: "quite, rather, very" },
  { hanzi: "同事", pinyin: "tóngshì", english: "colleague, coworker" },
  { hanzi: "同意", pinyin: "tóngyì", english: "to agree, to consent" },
  { hanzi: "头发", pinyin: "tóufa", english: "hair (on head)" },
  { hanzi: "突然", pinyin: "tūrán", english: "suddenly, all of a sudden" },
  { hanzi: "图书馆", pinyin: "túshūguǎn", english: "library" },
  { hanzi: "腿", pinyin: "tuǐ", english: "leg" },
  { hanzi: "外地", pinyin: "wàidì", english: "other place, away from home" },
  { hanzi: "外卖", pinyin: "wàimài", english: "takeaway, food delivery" },
  { hanzi: "外语", pinyin: "wàiyǔ", english: "foreign language" },
  { hanzi: "完成", pinyin: "wánchéng", english: "to complete, to finish" },
  { hanzi: "碗", pinyin: "wǎn", english: "bowl" },
  { hanzi: "晚点", pinyin: "wǎndiǎn", english: "to be delayed, running late" },
  { hanzi: "晚会", pinyin: "wǎnhuì", english: "evening party, evening show" },
  { hanzi: "网球", pinyin: "wǎngqiú", english: "tennis" },
  { hanzi: "网站", pinyin: "wǎngzhàn", english: "website" },
  { hanzi: "忘记", pinyin: "wàngjì", english: "to forget" },
  { hanzi: "为", pinyin: "wèi", english: "for, because of, in order to" },
  { hanzi: "为了", pinyin: "wèile", english: "in order to, for the sake of" },
  { hanzi: "卫生间", pinyin: "wèishēngjiān", english: "bathroom, restroom" },
  { hanzi: "文化", pinyin: "wénhuà", english: "culture, civilization" },
  { hanzi: "屋子", pinyin: "wūzi", english: "room, house" },
  { hanzi: "西", pinyin: "xī", english: "west" },
  { hanzi: "西北", pinyin: "xīběi", english: "northwest" },
  { hanzi: "西方", pinyin: "xīfāng", english: "the West, western" },
  ...
  { hanzi: "洗澡", pinyin: "xǐzǎo", english: "to bathe, to shower" },
  { hanzi: "夏天", pinyin: "xiàtiān", english: "summer" },
  { hanzi: "先", pinyin: "xiān", english: "first, in advance, before" },
  { hanzi: "香蕉", pinyin: "xiāngjiāo", english: "banana" },
  { hanzi: "相信", pinyin: "xiāngxìn", english: "to believe, to trust" },
  { hanzi: "箱子", pinyin: "xiāngzi", english: "box, chest, suitcase" },
  { hanzi: "向", pinyin: "xiàng", english: "towards, in the direction of" },
  { hanzi: "像", pinyin: "xiàng", english: "to resemble, to be like" },
  { hanzi: "相机", pinyin: "xiàngjī", english: "camera" },
  { hanzi: "小区", pinyin: "xiǎoqū", english: "residential community, housing estate" },
  { hanzi: "小心", pinyin: "xiǎoxīn", english: "careful, be careful" },
  ...
  { hanzi: "心里", pinyin: "xīnlǐ", english: "in one's heart, in one's mind" },
  { hanzi: "新年", pinyin: "xīnnián", english: "New Year" },
  { hanzi: "新闻", pinyin: "xīnwén", english: "news" },
  { hanzi: "新鲜", pinyin: "xīnxiān", english: "fresh, novel" },
  { hanzi: "信", pinyin: "xìn", english: "to believe; letter" },
  { hanzi: "信用卡", pinyin: "xìnyòngkǎ", english: "credit card" },
  { hanzi: "行", pinyin: "xíng", english: "okay, permissible; to go" },
  { hanzi: "行李", pinyin: "xíngli", english: "luggage, baggage" },
  { hanzi: "兴趣", pinyin: "xìngqù", english: "interest, hobby" },
  { hanzi: "休假", pinyin: "xiūjià", english: "to take a holiday, to be on leave" },
  { hanzi: "需要", pinyin: "xūyào", english: "to need, to require" },
  { hanzi: "选", pinyin: "xuǎn", english: "to choose, to select" },
  { hanzi: "选择", pinyin: "xuǎnzé", english: "to choose; choice, option" },
  { hanzi: "学期", pinyin: "xuéqī", english: "semester, term" },
  { hanzi: "牙", pinyin: "yá", english: "tooth" },
  { hanzi: "牙刷", pinyin: "yáshuā", english: "toothbrush" },
  { hanzi: "羊", pinyin: "yáng", english: "sheep, goat" },
  { hanzi: "养", pinyin: "yǎng", english: "to raise, to keep (animals/plants)" },
  { hanzi: "要求", pinyin: "yāoqiú", english: "to require, to demand; requirement" },
  { hanzi: "页", pinyin: "yè", english: "page; measure word for pages" },
  { hanzi: "一定", pinyin: "yídìng", english: "certain, fixed; certainly, definitely" },
  { hanzi: "一共", pinyin: "yígòng", english: "altogether, in total" },
  { hanzi: "一块儿", pinyin: "yíkuàir", english: "together, at the same place" },
  { hanzi: "一样", pinyin: "yíyàng", english: "same, alike, equal" },
  { hanzi: "以后", pinyin: "yǐhòu", english: "later, after, in the future" },
  { hanzi: "以前", pinyin: "yǐqián", english: "before, formerly, in the past" },
  { hanzi: "以上", pinyin: "yǐshàng", english: "above, more than, over" },
  { hanzi: "以外", pinyin: "yǐwài", english: "except, besides, beyond" },
  { hanzi: "以为", pinyin: "yǐwéi", english: "to think (wrongly), to assume" },
  { hanzi: "以下", pinyin: "yǐxià", english: "below, less than, under" },
  { hanzi: "一般", pinyin: "yìbān", english: "ordinary, general; usually" },
  { hanzi: "一边", pinyin: "yìbiān", english: "at the same time, simultaneously" },
  { hanzi: "一直", pinyin: "yìzhí", english: "always, continuously, straight" },
  { hanzi: "音乐", pinyin: "yīnyuè", english: "music" },
  { hanzi: "银行", pinyin: "yínháng", english: "bank" },
  { hanzi: "银行卡", pinyin: "yínhángkǎ", english: "bank card, debit card" },
  { hanzi: "饮料", pinyin: "yǐnliào", english: "drink, beverage" },
  { hanzi: "应该", pinyin: "yīnggāi", english: "should, ought to" },
  { hanzi: "影响", pinyin: "yǐngxiǎng", english: "to influence; influence, effect" },
  { hanzi: "用", pinyin: "yòng", english: "to use, to employ" },
  { hanzi: "邮件", pinyin: "yóujiàn", english: "mail, email" },
  { hanzi: "游客", pinyin: "yóukè", english: "tourist, visitor" },
  { hanzi: "游戏", pinyin: "yóuxì", english: "game" },
  { hanzi: "邮箱", pinyin: "yóuxiāng", english: "mailbox, email address" },
  { hanzi: "有关", pinyin: "yǒuguān", english: "related to, concerning, relevant" },
  { hanzi: "有名", pinyin: "yǒumíng", english: "famous, well-known" },
  { hanzi: "有用", pinyin: "yǒuyòng", english: "useful, helpful" },
  { hanzi: "又", pinyin: "yòu", english: "again, also, both...and..." },
  { hanzi: "羽毛球", pinyin: "yǔmáoqiú", english: "badminton" },
  { hanzi: "语言", pinyin: "yǔyán", english: "language" },
  { hanzi: "雨衣", pinyin: "yǔyī", english: "raincoat" },
  { hanzi: "遇到", pinyin: "yùdào", english: "to encounter, to come across" },
  { hanzi: "遇见", pinyin: "yùjiàn", english: "to meet, to run into" },
  { hanzi: "园", pinyin: "yuán", english: "garden, park" },
  { hanzi: "愿意", pinyin: "yuànyì", english: "willing, to be willing to" },
  { hanzi: "越", pinyin: "yuè", english: "more and more; to exceed" },
  { hanzi: "月亮", pinyin: "yuèliang", english: "moon" },
  { hanzi: "运动会", pinyin: "yùndònghuì", english: "sports meet, athletic games" },
  { hanzi: "运动员", pinyin: "yùndòngyuán", english: "athlete, sportsperson" },
  { hanzi: "咱们", pinyin: "zánmen", english: "we (inclusive), us" },
  { hanzi: "脏", pinyin: "zāng", english: "dirty, filthy" },
  { hanzi: "怎么办", pinyin: "zěnme bàn", english: "what to do, what should be done" },
  { hanzi: "怎样", pinyin: "zěnyàng", english: "how, in what way, what is it like" },
  { hanzi: "站", pinyin: "zhàn", english: "to stand; station, stop" },
  { hanzi: "张", pinyin: "zhāng", english: "measure word for flat objects; to open" },
  { hanzi: "长", pinyin: "zhǎng", english: "to grow, to develop" },
  { hanzi: "着急", pinyin: "zháojí", english: "anxious, worried, to feel urgent" },
  { hanzi: "照", pinyin: "zhào", english: "to shine, to photograph" },
  { hanzi: "照顾", pinyin: "zhàogù", english: "to take care of, to look after" },
  { hanzi: "照片", pinyin: "zhàopiàn", english: "photo, photograph" },
  { hanzi: "照相", pinyin: "zhàoxiàng", english: "to take a picture" },
  { hanzi: "直到", pinyin: "zhídào", english: "until, up to" },
  { hanzi: "只", pinyin: "zhǐ", english: "only, merely, just" },
  { hanzi: "纸", pinyin: "zhǐ", english: "paper" },
  { hanzi: "只能", pinyin: "zhǐ néng", english: "can only, only able to" },
  { hanzi: "只是", pinyin: "zhǐshì", english: "only, merely; but" },
  { hanzi: "只要", pinyin: "zhǐyào", english: "as long as, provided that" },
  { hanzi: "只有", pinyin: "zhǐyǒu", english: "only if, only when" },
  { hanzi: "中", pinyin: "zhōng", english: "middle, center" },
  { hanzi: "中间", pinyin: "zhōngjiān", english: "middle, between, among" },
  { hanzi: "终于", pinyin: "zhōngyú", english: "finally, at last, in the end" },
  { hanzi: "种", pinyin: "zhǒng", english: "type, kind; measure word for kinds" },
  { hanzi: "重要", pinyin: "zhòngyào", english: "important, significant" },
  { hanzi: "周末", pinyin: "zhōumò", english: "weekend" },
  { hanzi: "主要", pinyin: "zhǔyào", english: "main, principal, primary" },
  { hanzi: "注意", pinyin: "zhùyì", english: "to pay attention to, to notice" },
  { hanzi: "住院", pinyin: "zhùyuàn", english: "to be hospitalized, to check into hospital" },
  { hanzi: "字典", pinyin: "zìdiǎn", english: "dictionary" },
  { hanzi: "自行车", pinyin: "zìxíngchē", english: "bicycle" },
  { hanzi: "总", pinyin: "zǒng", english: "always; total, overall" },
  { hanzi: "总是", pinyin: "zǒngshì", english: "always, at all times" },
  { hanzi: "嘴", pinyin: "zuǐ", english: "mouth, beak" },
  { hanzi: "最好", pinyin: "zuìhǎo", english: "best; it would be best to" },
  { hanzi: "最后", pinyin: "zuìhòu", english: "final, last; finally" },
  { hanzi: "最近", pinyin: "zuìjìn", english: "recently, lately" },
